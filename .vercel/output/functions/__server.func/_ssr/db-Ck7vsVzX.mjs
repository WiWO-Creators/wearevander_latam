//#region node_modules/.nitro/vite/services/ssr/assets/db-Ck7vsVzX.js
...
var _0002_magazine_default = "create table if not exists saved_stories (\n  user_id text not null,\n  slug text not null,\n  created_at timestamptz not null default now(),\n  primary key (user_id, slug)\n);\n\ncreate table if not exists newsletter (\n  email text primary key,\n  user_id text,\n  created_at timestamptz not null default now()\n);\n";
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0002_magazine.sql": _0002_magazine_default
		});
