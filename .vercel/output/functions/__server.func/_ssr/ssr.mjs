...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B-Qu-aG6.mjs");
...
var manifest = {
	"1809b4c7b7d18b727f00bc3ba097224b5e0e9434f94491ee925c662e5bfc69c8": {
		functionName: "getSavedSlugs_createServerFn_handler",
		importer: () => import("./magazine-87IXKXaU.mjs")
	},
	"9368d403e2978e27d5105d6c9f6901ffcd09ebbdef3adda8415f8a39ee4218d2": {
		functionName: "subscribeNewsletter_createServerFn_handler",
		importer: () => import("./magazine-87IXKXaU.mjs")
	},
	"a8a98129034a1f75799f867cd5f39ba606e06516149cfbb749a54a15bf6b2b3f": {
		functionName: "toggleSavedStory_createServerFn_handler",
		importer: () => import("./magazine-87IXKXaU.mjs")
	},
	"ffd8807b3302d4f5db3d7eefbd5152b18091d8edc2b5d49cd8703f72f11c6f4f": {
		functionName: "askVander_createServerFn_handler",
		importer: () => import("./magazine-87IXKXaU.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DC-BlURD.mjs").then((n) => n.t),
